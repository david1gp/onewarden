...
- [x] 6. Test Zitadel login through the public web UI with `ssotest`; first-login master-password setup, vault unlock, reload lock, and subsequent unlock all pass.
