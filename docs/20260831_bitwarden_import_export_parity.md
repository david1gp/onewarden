...
- [x] 7. Add end-to-end compatibility fixtures and browser verification for representative import/export flows. Current context: a real adapter-to-server/database compatibility test covers additive JSON import and decrypted/CSV/portable export round trips; browser checks cover format selection, warnings, validation, counts, downloads, and portable import/export behavior.
