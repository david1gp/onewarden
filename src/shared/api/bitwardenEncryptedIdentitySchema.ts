...
export const bitwardenEncryptedIdentitySchema = v.looseObject({
...
export type BitwardenEncryptedIdentity = v.InferOutput<typeof bitwardenEncryptedIdentitySchema>
