...
export function organizationOwnerMiddleware(
  ...
  return async (context, next) => {
    ...
    if (!organizationMembershipRoleCheck(guardResult.data.membership, "owner"))
      return apiErrorResponseCreate(
        authenticationGuardErrorCreate("organizationOwnerMiddleware", "You need to be Owner to call this endpoint"),
      )
