...
export const extensionBackgroundCollectionDtoSchema = v.strictObject({
...
export type ExtensionBackgroundCollectionDto = v.InferOutput<typeof extensionBackgroundCollectionDtoSchema>
