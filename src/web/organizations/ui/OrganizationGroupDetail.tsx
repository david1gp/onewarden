          ...
          <div class="space-y-6">
            ...
            <div class="flex items-start justify-between border-b border-slate-200 pb-5 dark:border-slate-800">
              <div class="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p class="font-mono text-slate-500 text-xs dark:text-slate-400">ID: {grp().id}</p>
                </div>
              </div>
                      ...
                      <div class="flex items-center justify-between p-3 text-xs">
                        <div>
                          ...
                          <Show when={member.email && member.email !== member.name}>
                            <p class="text-slate-600 text-[11px]">{member.email}</p>
                          </Show>
                        </div>
                        <span class="font-mono text-[11px] text-slate-600">ID: {member.id}</span>
                      </div>
                    )}
                  </For>
                </div>
            ...
            <div>
              ...
              <Show
                when={!grp().accessAll}
                fallback={
                  <div class="mt-2 rounded-md border border-blue-200 bg-blue-50/50 p-3 text-xs text-blue-800 dark:border-blue-900 dark:bg-blue-950/30 dark:text-blue-300">
