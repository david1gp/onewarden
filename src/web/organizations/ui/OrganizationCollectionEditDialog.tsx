  ...
  return (
    ...
    >
      <form onSubmit={state.handleSubmit} class="space-y-4">
        ...
        <div>
          <label class="block font-medium text-slate-700 text-xs dark:text-slate-300" for="edit-col-name">
            Collection Name
          </label>
          <Input
            id="edit-col-name"
        ...
        <div>
          <label class="block font-medium text-slate-700 text-xs dark:text-slate-300" for="edit-col-ext">
            External ID
          </label>
          <Input
            id="edit-col-ext"
        ...
        <div class="rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-900/50">
          ...
          <div class="mt-2.5 max-h-48 overflow-y-auto divide-y divide-slate-200 dark:divide-slate-800">
            <For
              each={state.members()}
              fallback={<p class="text-xs text-slate-400 italic">No organization members available.</p>}
            >
              {(mem) => {
