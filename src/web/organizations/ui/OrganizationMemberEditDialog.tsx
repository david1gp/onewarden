  ...
  return (
    ...
    >
      <form onSubmit={state.handleSubmit} class="space-y-4">
        ...
        <div>
          <label class="block font-medium text-slate-700 text-xs dark:text-slate-300" for="edit-member-role">
            Organization Role
          </label>
          <select
            id="edit-member-role"
        ...
        <div class="rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-900/50">
          <div class="flex items-center gap-2">
            ...
            <span class="font-medium text-xs text-slate-900 dark:text-slate-100">Grant access to all collections</span>
          </div>
            ...
            <div class="mt-3 space-y-2 border-t border-slate-200 pt-3 dark:border-slate-800">
              ...
              <div class="max-h-48 overflow-y-auto divide-y divide-slate-200 dark:divide-slate-800">
                <For
                  ...
                  fallback={<p class="text-xs text-slate-400 italic">No collections available.</p>}
                >
                  {(col) => {
