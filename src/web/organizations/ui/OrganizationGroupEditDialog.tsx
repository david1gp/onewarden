  ...
  return (
    ...
    >
      <form onSubmit={state.handleSubmit} class="space-y-4">
        ...
        <div>
          <label class="block font-medium text-slate-700 text-xs dark:text-slate-300" for="edit-grp-name">
            Group Name
          </label>
          <Input
            id="edit-grp-name"
        ...
        <div>
          <label class="block font-medium text-slate-700 text-xs dark:text-slate-300" for="edit-grp-ext">
