...
const duplicatedRouteRegistrations = [
  ...
  { basePath: "/", method: "PUT", path: "/api/ciphers/:cipher_id/collections" },
  { basePath: "/", method: "PUT", path: "/api/ciphers/:cipher_id/collections-admin" },
  { basePath: "/", method: "PUT", path: "/api/ciphers/:cipher_id/collections_v2" },
  ...
  { basePath: "/", method: "PUT", path: "/api/ciphers/:cipher_id/share" },
  { basePath: "/", method: "PUT", path: "/api/ciphers/:cipher_id/unarchive" },
  { basePath: "/", method: "PUT", path: "/api/ciphers/share" },
...
const currentRouteRegistrations = [
  ...
  ...[
    { basePath: "/", method: "DELETE", path: "/api/organizations/:org_id/groups/:group_id" },
    { basePath: "/", method: "DELETE", path: "/api/organizations/:org_id/groups" },
    { basePath: "/", method: "GET", path: "/api/organizations/:org_id/groups" },
    { basePath: "/", method: "GET", path: "/api/organizations/:org_id/groups/:group_id" },
    { basePath: "/", method: "GET", path: "/api/organizations/:org_id/groups/:group_id/details" },
    { basePath: "/", method: "GET", path: "/api/organizations/:org_id/groups/:group_id/users" },
    { basePath: "/", method: "GET", path: "/api/organizations/:org_id/groups/details" },
    { basePath: "/", method: "POST", path: "/api/organizations/:org_id/groups" },
    { basePath: "/", method: "POST", path: "/api/organizations/:org_id/groups/:group_id" },
    { basePath: "/", method: "POST", path: "/api/organizations/:org_id/groups/:group_id/delete" },
    { basePath: "/", method: "POST", path: "/api/organizations/:org_id/groups/:group_id/delete-user/:member_id" },
    { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/groups/:group_id" },
  ...
  ...[{ basePath: "/", method: "POST", path: "/api/ciphers/import-organization" }].flatMap((registration) => [
    registration,
    registration,
    registration,
  ]),
  ...
  ...[{ basePath: "/", method: "PUT", path: "/api/auth-requests/:auth_request_id" }].flatMap((registration) => [
    registration,
    registration,
  ]),
  ...
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/export" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/export" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies/token" },
  {
    basePath: "/",
    method: "GET",
    path: "/api/organizations/00000000-01DC-01DC-01DC-000000000000/policies/master-password",
  },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies/master-password" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies/master-password" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies/master-password" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies/:pol_type" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies/:pol_type" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/policies/:pol_type" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/events" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/events" },
  { basePath: "/", method: "GET", path: "/api/organizations/:org_id/events" },
  ...
  ...[{ basePath: "/", method: "POST", path: "/api/ciphers/purge" }].flatMap((registration) => [
    registration,
    registration,
    registration,
  ]),
  ...
  { basePath: "/", method: "POST", path: "/api/auth-requests" },
  ...
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/users/:member_id/restore" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/users/:member_id/restore" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/users/:member_id/recover-account" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/users/:member_id/recover-account" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/users/:member_id/recover-account" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/users/:member_id/reset-password" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/users/:member_id/reset-password" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/users/:member_id/reset-password" },
  {
    basePath: "/",
  ...
  { basePath: "/", method: "DELETE", path: "/api/organizations/:org_id" },
  { basePath: "/", method: "DELETE", path: "/api/organizations/:org_id" },
  { basePath: "/", method: "POST", path: "/events/collect" },
  { basePath: "/", method: "POST", path: "/events/collect" },
  ...
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/policies/:pol_type" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/policies/:pol_type" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/policies/:pol_type" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/policies/:pol_type/vnext" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/policies/:pol_type/vnext" },
  { basePath: "/", method: "PUT", path: "/api/organizations/:org_id/policies/:pol_type/vnext" },
  ...[
    { basePath: "/", method: "DELETE", path: "/api/organizations/:org_id/domain/:id" },
    { basePath: "/", method: "GET", path: "/api/organizations/:org_id/domain" },
    { basePath: "/", method: "GET", path: "/api/organizations/:org_id/domain/:id" },
    { basePath: "/", method: "GET", path: "/api/organizations/:org_id/sso" },
    { basePath: "/", method: "POST", path: "/api/organizations/:org_id/domain" },
    { basePath: "/", method: "POST", path: "/api/organizations/:org_id/domain/:id/remove" },
    { basePath: "/", method: "POST", path: "/api/organizations/:org_id/domain/:id/verify" },
    { basePath: "/", method: "POST", path: "/api/organizations/:org_id/sso" },
  ].flatMap((registration) => [registration, registration, registration]),
  { basePath: "/", method: "POST", path: "/api/organizations/domain/sso/verified" },
